...
// -------------------------------------------------------------------------
// class Restaurant: reusable vector of tables
//
class Restaurant
{
public:
...
// -------------------------------------------------------------------------
// GetTableAt: get table at the position
//
inline
...
// -------------------------------------------------------------------------
// SetTableAt: set table at the position
//
inline
...
#ifdef __DEBUG__
    if( !values_ || loc < 0 || length_ <= loc )
        throw myruntime_error( "Restaurant: Memory access error" );
#endif
    values_[loc] = value;
}
...
// -------------------------------------------------------------------------
// RemTableAt: remove table at the position
//
inline
