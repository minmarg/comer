...
if [[ ! -f "$ssp" ]]; then echo "ERROR: Perl script \`ssp.pl' from the \`comer' package not found: $ssp"; exit 1; fi
if [[ ! -f "$inssp" ]]; then echo "ERROR: Perl script \`inssp.pl' from the \`comer' package not found: $inssp"; exit 1; fi
